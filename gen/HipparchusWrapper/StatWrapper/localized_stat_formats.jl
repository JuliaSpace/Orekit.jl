...
function get_localized_string(obj::LocalizedStatFormats, arg0::Locale)
    return jcall(obj, "getLocalizedString", JString, (Locale,), arg0)
end

function get_source_string(obj::LocalizedStatFormats)
...
function value_of(::Type{LocalizedStatFormats}, arg0::JString)
    return jcall(LocalizedStatFormats, "valueOf", LocalizedStatFormats, (JString,), arg0)
end

function values(::Type{LocalizedStatFormats})
    return jcall(LocalizedStatFormats, "values", Vector{LocalizedStatFormats}, ())
end
