...
function Product(arg0::Product)
    return Product((Product,), arg0)
end

function clear(obj::Product)
    return jcall(obj, "clear", void, ())
end

function increment(obj::Product, arg0::jdouble)
    return jcall(obj, "increment", void, (jdouble,), arg0)
end

function copy(obj::Product)
    return jcall(obj, "copy", Product, ())
end

function get_result(obj::Product)
    return jcall(obj, "getResult", jdouble, ())
end

function evaluate(obj::Product, arg0::Vector{jdouble}, arg1::Vector{jdouble}, arg2::jint, arg3::jint)
    return jcall(obj, "evaluate", jdouble, (Vector{jdouble}, Vector{jdouble}, jint, jint), arg0, arg1, arg2, arg3)
end

function evaluate(obj::Product, arg0::Vector{jdouble}, arg1::jint, arg2::jint)
    return jcall(obj, "evaluate", jdouble, (Vector{jdouble}, jint, jint), arg0, arg1, arg2)
end

function get_n(obj::Product)
    return jcall(obj, "getN", jlong, ())
end

function aggregate(obj::Product, arg0::Product)
    return jcall(obj, "aggregate", void, (Product,), arg0)
end
