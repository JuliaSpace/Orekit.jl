function clear(obj::FirstMoment)
    return jcall(obj, "clear", void, ())
end

function increment(obj::FirstMoment, arg0::jdouble)
    return jcall(obj, "increment", void, (jdouble,), arg0)
end

function copy(obj::FirstMoment)
    return jcall(obj, "copy", FirstMoment, ())
end

function get_result(obj::FirstMoment)
    return jcall(obj, "getResult", jdouble, ())
end

function get_n(obj::FirstMoment)
