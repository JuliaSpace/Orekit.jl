...
function value_of(::Type{AlternativeHypothesis}, arg0::JString)
    return jcall(AlternativeHypothesis, "valueOf", AlternativeHypothesis, (JString,), arg0)
end
...
function values(::Type{AlternativeHypothesis})
    return jcall(AlternativeHypothesis, "values", Vector{AlternativeHypothesis}, ())
end
