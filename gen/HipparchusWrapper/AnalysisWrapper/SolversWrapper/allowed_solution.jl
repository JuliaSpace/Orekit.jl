...
function value_of(::Type{AllowedSolution}, arg0::JString)
    return jcall(AllowedSolution, "valueOf", AllowedSolution, (JString,), arg0)
end
...
function values(::Type{AllowedSolution})
    return jcall(AllowedSolution, "values", Vector{AllowedSolution}, ())
end
