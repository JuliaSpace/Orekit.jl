...
function value_of(::Type{GoalType}, arg0::JString)
    return jcall(GoalType, "valueOf", GoalType, (JString,), arg0)
end

function values(::Type{GoalType})
    return jcall(GoalType, "values", Vector{GoalType}, ())
end
