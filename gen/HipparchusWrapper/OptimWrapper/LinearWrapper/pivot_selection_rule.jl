function values(::Type{PivotSelectionRule})
    return jcall(PivotSelectionRule, "values", Vector{PivotSelectionRule}, ())
end

function value_of(::Type{PivotSelectionRule}, arg0::JString)
    return jcall(PivotSelectionRule, "valueOf", PivotSelectionRule, (JString,), arg0)
end
