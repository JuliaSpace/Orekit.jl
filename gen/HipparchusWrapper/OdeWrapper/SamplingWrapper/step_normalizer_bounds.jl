function values(::Type{StepNormalizerBounds})
    return jcall(StepNormalizerBounds, "values", Vector{StepNormalizerBounds}, ())
end

function value_of(::Type{StepNormalizerBounds}, arg0::JString)
    return jcall(StepNormalizerBounds, "valueOf", StepNormalizerBounds, (JString,), arg0)
end

function first_included(obj::StepNormalizerBounds)
    return jcall(obj, "firstIncluded", jboolean, ())
end

function last_included(obj::StepNormalizerBounds)
    return jcall(obj, "lastIncluded", jboolean, ())
end
