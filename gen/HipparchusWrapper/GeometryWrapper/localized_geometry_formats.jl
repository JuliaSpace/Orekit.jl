function values(::Type{LocalizedGeometryFormats})
    return jcall(LocalizedGeometryFormats, "values", Vector{LocalizedGeometryFormats}, ())
end

function value_of(::Type{LocalizedGeometryFormats}, arg0::JString)
    return jcall(LocalizedGeometryFormats, "valueOf", LocalizedGeometryFormats, (JString,), arg0)
end

function get_source_string(obj::LocalizedGeometryFormats)
    return jcall(obj, "getSourceString", JString, ())
end

function get_localized_string(obj::LocalizedGeometryFormats, arg0::Locale)
