function SubLimitAngle(arg0::Hyperplane, arg1::Region)
    return SubLimitAngle((Hyperplane, Region), arg0, arg1)
end
...
function get_size(obj::SubLimitAngle)
    return jcall(obj, "getSize", jdouble, ())
end

function is_empty(obj::SubLimitAngle)
...
function split(obj::SubLimitAngle, arg0::Hyperplane)
