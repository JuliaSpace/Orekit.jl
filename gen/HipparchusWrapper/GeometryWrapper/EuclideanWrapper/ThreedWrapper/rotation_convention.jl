function values(::Type{RotationConvention})
    return jcall(RotationConvention, "values", Vector{RotationConvention}, ())
end

function value_of(::Type{RotationConvention}, arg0::JString)
    return jcall(RotationConvention, "valueOf", RotationConvention, (JString,), arg0)
end
