...
function depends_on_position_only(obj::AbstractRadiationForceModel)
...
function get_events_detectors(obj::AbstractRadiationForceModel)
    return jcall(obj, "getEventsDetectors", Stream, ())
end

function get_field_events_detectors(obj::AbstractRadiationForceModel, arg0::Field)
