function InertialForces(arg0::Frame)
    return InertialForces((Frame,), arg0)
end

function acceleration(obj::InertialForces, arg0::FieldSpacecraftState, arg1::Vector{RealFieldElement})
    return jcall(obj, "acceleration", FieldVector3D, (FieldSpacecraftState, Vector{RealFieldElement}), arg0, arg1)
end

function acceleration(obj::InertialForces, arg0::SpacecraftState, arg1::Vector{jdouble})
...
function depends_on_position_only(obj::InertialForces)
...
function get_events_detectors(obj::InertialForces)
    return jcall(obj, "getEventsDetectors", Stream, ())
end

function get_field_events_detectors(obj::InertialForces, arg0::Field)
    return jcall(obj, "getFieldEventsDetectors", Stream, (Field,), arg0)
end

function get_parameter_driver(obj::InertialForces, arg0::JString)
...
function get_parameters_drivers(obj::InertialForces)
