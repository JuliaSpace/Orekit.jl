function get_initial_state(obj::EphemerisSegmentPropagator)
    return jcall(obj, "getInitialState", SpacecraftState, ())
end

function reset_initial_state(obj::EphemerisSegmentPropagator, arg0::SpacecraftState)
    return jcall(obj, "resetInitialState", void, (SpacecraftState,), arg0)
end

function get_min_date(obj::EphemerisSegmentPropagator)
    return jcall(obj, "getMinDate", AbsoluteDate, ())
end

function get_max_date(obj::EphemerisSegmentPropagator)
    return jcall(obj, "getMaxDate", AbsoluteDate, ())
end

function get_pv_coordinates(obj::EphemerisSegmentPropagator, arg0::AbsoluteDate, arg1::Frame)
