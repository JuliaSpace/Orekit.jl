function values(::Type{OrekitMessages})
    return jcall(OrekitMessages, "values", Vector{OrekitMessages}, ())
end

function value_of(::Type{OrekitMessages}, arg0::JString)
    return jcall(OrekitMessages, "valueOf", OrekitMessages, (JString,), arg0)
end

function get_source_string(obj::OrekitMessages)
    return jcall(obj, "getSourceString", JString, ())
end

function get_localized_string(obj::OrekitMessages, arg0::Locale)
