...
function add_event_detector(obj::AbstractPropagator, arg0::EventDetector)
    return jcall(obj, "addEventDetector", void, (EventDetector,), arg0)
end

function clear_events_detectors(obj::AbstractPropagator)
...
function get_events_detectors(obj::AbstractPropagator)
...
function get_generated_ephemeris(obj::AbstractPropagator)
...
function propagate(obj::Propagator, arg0::AbsoluteDate, arg1::AbsoluteDate)
