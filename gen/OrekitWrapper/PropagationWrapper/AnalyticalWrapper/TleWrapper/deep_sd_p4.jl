function DeepSDP4(arg0::TLE, arg1::AttitudeProvider, arg2::jdouble)
    return DeepSDP4((TLE, AttitudeProvider, jdouble), arg0, arg1, arg2)
end

function DeepSDP4(arg0::TLE, arg1::AttitudeProvider, arg2::jdouble, arg3::Frame)
    return DeepSDP4((TLE, AttitudeProvider, jdouble, Frame), arg0, arg1, arg2, arg3)
end

function select_extrapolator(::Type{TLEPropagator}, arg0::TLE, arg1::AttitudeProvider, arg2::jdouble, arg3::Frame)
    return jcall(TLEPropagator, "selectExtrapolator", TLEPropagator, (TLE, AttitudeProvider, jdouble, Frame), arg0, arg1, arg2, arg3)
end

function select_extrapolator(::Type{TLEPropagator}, arg0::TLE, arg1::AttitudeProvider, arg2::jdouble)
    return jcall(TLEPropagator, "selectExtrapolator", TLEPropagator, (TLE, AttitudeProvider, jdouble), arg0, arg1, arg2)
end

function select_extrapolator(::Type{TLEPropagator}, arg0::TLE, arg1::Frames)
    return jcall(TLEPropagator, "selectExtrapolator", TLEPropagator, (TLE, Frames), arg0, arg1)
end

function select_extrapolator(::Type{TLEPropagator}, arg0::TLE)
    return jcall(TLEPropagator, "selectExtrapolator", TLEPropagator, (TLE,), arg0)
end

function get_mu(::Type{TLEPropagator})
    return jcall(TLEPropagator, "getMU", jdouble, ())
end

function get_tle(obj::TLEPropagator)
    return jcall(obj, "getTLE", TLE, ())
end

function reset_initial_state(obj::TLEPropagator, arg0::SpacecraftState)
    return jcall(obj, "resetInitialState", void, (SpacecraftState,), arg0)
end

function get_pv_coordinates(obj::TLEPropagator, arg0::AbsoluteDate)
    return jcall(obj, "getPVCoordinates", PVCoordinates, (AbsoluteDate,), arg0)
end

function get_frame(obj::TLEPropagator)
