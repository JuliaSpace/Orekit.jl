function values(::Type{PropagationType})
    return jcall(PropagationType, "values", Vector{PropagationType}, ())
end

function value_of(::Type{PropagationType}, arg0::JString)
    return jcall(PropagationType, "valueOf", PropagationType, (JString,), arg0)
end
