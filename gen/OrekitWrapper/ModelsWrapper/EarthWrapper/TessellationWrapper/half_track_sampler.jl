function get_half_track(obj::HalfTrackSampler)
    return jcall(obj, "getHalfTrack", List, ())
end

function handle_step(obj::HalfTrackSampler, arg0::SpacecraftState, arg1::jboolean)
