function values(::Type{ViennaModelType})
    return jcall(ViennaModelType, "values", Vector{ViennaModelType}, ())
end

function value_of(::Type{ViennaModelType}, arg0::JString)
    return jcall(ViennaModelType, "valueOf", ViennaModelType, (JString,), arg0)
end
